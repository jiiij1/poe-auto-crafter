...
DEFAULT_CONFIG = {
    ...
    "copy_timeout": 0.134,              # 单次等待剪贴板变化超时（秒）
    ...
    "read_failure_threshold": 0.134,    # 判定长时间读取不到剪贴板的阈值（秒）
...
class PoeClipboardMakerApp:
    ...
    def automation_loop(self, rules):
        ...
        copy_timeout = float(self.config.get("copy_timeout", 0.25))
        ...
        pre_copy_delay = float(self.config.get("pre_copy_delay", 0.08))
